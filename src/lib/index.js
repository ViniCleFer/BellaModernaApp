...
export default class Timeline extends Component {
  ...
  renderTime = (item, index) => {
    ...
    return (
      <View
        style={[styles.timeContainer, timeContainerWrapper, timeContainerStyle]}
      >
        <View>
  ...
  renderCircleAndLineVertical = (item, index) => {
    ...
    const innerCircle = this.renderInnerCircle(item);
    const heightLineTop = marginTopCircle / 2;
    const renderTopLine =
      renderLine || index < 1 ? (
        renderLine
      ) : (
